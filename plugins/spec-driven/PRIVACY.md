...
The Spec-Driven Development Plugin is a Claude Code plugin that runs entirely on your local machine. It does not collect, transmit, or store any personal data or telemetry.
...
Updates to this policy will be reflected in this file with an updated date. Check the git history for changes.
